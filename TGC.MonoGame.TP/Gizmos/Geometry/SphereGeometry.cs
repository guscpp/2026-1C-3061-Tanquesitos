...
namespace TGC.MonoGame.TP.Gizmos.Geometry
{
    /// <summary>
    ///     Gizmo for drawing Wire Spheres.
    /// </summary>
    class SphereGeometry : RadialGeometry
    {
        /// <summary>
        ...
        public SphereGeometry(GraphicsDevice graphicsDevice, int subdivisions) : base(graphicsDevice)
        {
